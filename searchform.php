<form role="search" method="get" <?php echo esc_url(home_url('/')) ?>>
  <input type="hidden" name="post_type" value="buku">
  <div class="relative">
    <Input
      type="search"
      placeholder="<?php echo esc_attr_x('Search books...', 'placeholder', 'ebookgua') ?>"
      value="<?php echo get_search_query() ?>"
      name="s"
      title="<?php echo esc_attr_x('Search for:', 'label', 'ebookgua') ?>"
