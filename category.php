<?php
/**
 * Category Archive Template (manual query)
 */
get_header();
...
$args = [
    ...
    'cat' => $term->term_id, // use category ID
];
...
<section class="max-w-7xl mx-auto bg-white my-2 mb-20 mt-10"> 
  <div class="max-w-6xl mx-10">
    ...
    <h2 class="text-2xl font-bold text-gray-900 mb-2">
      Category: <?php echo esc_html($term->name); ?>
    </h2>
    
    <?php if (category_description()) { ?>
      <p class="text-gray-600 mb-5"><?php echo category_description(); ?></p>
    <?php } ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
      ...
      <?php } else { ?>
        <p><?php _e('No posts found in this category.', 'ebookgua'); ?></p>
      <?php } ?>
    </div>         
  </div>   
<div class="mt-8 flex justify-center"> <?php
